...
This is a function written to calculate the ROC curve for a terrane roughness map and a boolean map of landslide (0 = not landslide; 1 = mapped landslide)

Input:
    - Roughness map
    - Landslide Boolean Map
    - Range for the threshold of roughness
